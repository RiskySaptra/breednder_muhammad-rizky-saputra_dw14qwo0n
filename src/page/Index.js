        ...
        <div id="s" className="boxRight-index">
          ...
          <div className="boxRight-Footer">
            <div style={{ flex: 2, maxWidth: "200px" }}>
              <Button
                onClick={() =>
                  this.setState({ showing: !showing, text: !text })
                }
                size="sm"
                variant="secondary btn-pill"
                block
              >
                <b>{text ? "Hide" : "Show"}</b>
              </Button>
            ...
            <div style={{ flex: 10, display: showing ? "flex" : "none" }}>
              <div style={{ flex: 1.5 }}>
                <FaRegCaretSquareLeft size="2em" className="react-icons" />
                <b>NO</b>
              </div>
              <div style={{ flex: 1.5 }}>
                <FaRegCaretSquareRight size="2em" className="react-icons" />
                <b>YES</b>
              </div>
              <div style={{ flex: 3 }}>
                <FaRegCaretSquareUp size="2em" className="react-icons" />
                <b>OPEN PROFILE</b>
              </div>
              <div style={{ flex: 3 }}>
                <FaRegCaretSquareDown size="2em" className="react-icons" />
                <b>CLOSE PROFILE</b>
              </div>
              <div style={{ flex: 2, marginRight: "10px" }}>
                <Button
                  ...
                  block
                  disabled
                  style={{ height: "28px", borderWidth: "3px" }}
                ></Button>
              </div>
              <div style={{ flex: 2 }}>
                <b>NEXT PHOTO</b>
