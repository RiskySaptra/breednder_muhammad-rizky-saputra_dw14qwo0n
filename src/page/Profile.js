        ...
        <div id="x" className="boxRight-profile">
          ...
          <div className="box-profile">
            ...
            <div className="for">
              ...
              <p>
                <IoIosPerson style={{ fontSize: "1.2em" }} /> Breeder : Risky
              </p>
              <p>
                <MdLocationOn style={{ fontSize: "1.2em" }} /> 10 KM from here
              </p>
              <p>
                <FaTransgender style={{ fontSize: "1.2em" }} /> Male - Adult
              </p>
              <p>
                <MdPhone style={{ fontSize: "1.2em" }} /> Phone Breeder : 0821
                9796 5530
              </p>
              <h3 style={{ margin: "5px" }}>About</h3>
              <p className="abt" style={{ margin: "5px" }}>
